...
class RecruiterActiveExperience{
    ...
    init(title: String, date: String, time: String, accepted: String, pending: String, imageURL: String, expID: String, organisation: String, bannerURL: String, rating: Double, age: String, location: String, category: String, description: String) {
        self._title = title
        self._date = date
        self._time = time
