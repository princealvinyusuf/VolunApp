...
class HomeVC: UIViewController, UITextFieldDelegate, NoCityFoundProtocol, ExperienceSearchProtocol {
    ...
    override func viewDidLoad() {
        ...
        trendingTableview.backgroundView = UIImageView(image: UIImage(named: "bg ececec"))
    ...
    @IBAction func buttonPersonTapped(_ sender: Any) {
        do{
    ...
    func loadExperiences(){
        DataService.instance.getExperiencesForCity() { (returnedExperiences) in
