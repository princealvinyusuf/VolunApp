...
class Experience{
    ...
    init(location: String, title: String, rating: Double, shortDescription: String, longDescription: String, date: String, preciseLocation: String, category: String, ageGroup: String, iconPhoto: String, bannerPhoto: String, id: String, time: String, recruiter: String, applydate: String, requirement: String, fee: String, duration: String) {
