...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let yourAPI = "AIzaSyBeSyQVgx8WQLgxVe-34uFZK9jIw-ZdCxg"
...
//        UIApplication.shared.statusBarStyle = .lightContent
        ...
        UITabBarItem.appearance().titlePositionAdjustment = UIOffset(horizontal: 0, vertical: 1.5)
        let tabBarItemApperance = UITabBarItem.appearance()
        
        // Unselected text color of tab bar
        tabBarItemApperance.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: 9, weight: .semibold), NSAttributedString.Key.foregroundColor:UIColor(red:0.29, green:0.29, blue:0.29, alpha:1.0)], for: UIControl.State.normal)
        
        // Selected text Color of Tab Bar
        tabBarItemApperance.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.systemFont(ofSize: 9, weight: .semibold), NSAttributedString.Key.foregroundColor:UIColor.white], for: UIControl.State.selected)
